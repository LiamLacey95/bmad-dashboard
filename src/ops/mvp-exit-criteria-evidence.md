...
| Reconnect/resync behavior validated | Pass | `tests/server/workflow-websocket-gateway.test.ts`, `tests/client/workflow-live-state.test.ts` |
...
| UAT checklist for journey + theme/responsive parity | Pass | `src/ops/uat-checklist.md` |
